...
tasks.forEach((task) => {
  ...
  document.getElementById('add-task-btn').addEventListener('click', function() {
    ...
    newCard.innerHTML = `
      ...
      <p style="color: #a0a3af; font-size: 14px; margin-top: 4px; margin-bottom: 0px;">12th &nbsp; <img src="./img/Ellipse 125.png" alt=""> &nbsp; Jan Assigned to <span style="font-size: 15px; color: rgb(88, 87, 87);">${assigneeFirstName}</span></p>
